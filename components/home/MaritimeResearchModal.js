...
export default function MaritimeResearchModal({ 
  area, 
  isOpen, 
  onClose, 
  onSelectArea, 
      ...
      >
        ...
        <div className="relative z-20 px-6 sm:px-8 py-4 bg-[#f5ecdf] border-b border-[#8b6f5e]/20 flex items-center justify-between flex-shrink-0">
          ...
          <button
            ...
            className="w-8 h-8 rounded-full bg-[#5c3a2a]/10 hover:bg-[#5c3a2a] text-[#5c3a2a] hover:text-white flex items-center justify-center transition-all duration-200 cursor-pointer flex-shrink-0"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="overflow-y-auto flex-1 px-6 sm:px-8 py-6 space-y-6">
            ...
            >
              ...
              {totalImages > 1 && (
                <div className="absolute top-0 left-0 right-0 h-1 bg-white/20 z-20 overflow-hidden">
                  <div 
                    className="h-full bg-gradient-to-r from-[#2d7d7d] to-[#4a9d9d] transition-all ease-linear"
          ...
          <div className="pt-1">
            <div className="p-5 sm:p-6 rounded-2xl bg-[#f7ead8]/80 border border-[#8b6f5e]/25 shadow-sm hover:border-[#2d7d7d]/35 transition-colors">
        ...
        {allAreas.length > 1 && (
          <div className="px-6 sm:px-8 py-3 bg-[#f5ecdf] border-t border-[#8b6f5e]/20 flex items-center justify-between flex-shrink-0">
            <button
              ...
              className="flex items-center space-x-1.5 text-xs sm:text-sm font-serif-body font-semibold text-[#5c3a2a] hover:text-[#2d7d7d] transition-colors cursor-pointer"
            >
