        ...
        <div className="lg:w-full text-center pb-8 sm:pb-12 md:pb-16 hero-content">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl hero-subtitle text-[#8b6f5e] mb-4 sm:mb-6 md:mb-8 font-serif-body max-w-3xl mx-auto leading-relaxed">
              Our Centre undertakes pioneering research to rediscover, document, and digitize India's indigenous knowledge - whether it's the wisdom of ancient shipbuilders and seafarers along the western coast, or the storytelling legacies embedded in Chitrakathi and folk visual arts.
            </p>
          </motion.div>
        </div>
      </div>
