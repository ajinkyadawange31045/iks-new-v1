        ...
        <div className="lg:w-full text-center pb-8 sm:pb-12 md:pb-16 hero-content">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl hero-subtitle text-[#8b6f5e] mb-4 sm:mb-6 md:mb-8 font-serif-body max-w-3xl mx-auto leading-relaxed">
              We welcome scholars, students, artists, and institutions to work with us in exploring India's maritime and artistic traditions. If you are passionate about research, storytelling, documentation, or visual culture, there’s a way for you to contribute       
            </p>
          </motion.div>
        </div>
      </div>
